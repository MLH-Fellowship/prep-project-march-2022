    ...
    return (
      <>
        ...
        <div>
          ...
          {/* The SearchBox components below is not working effectively
          It does not update the city variable with the setCity()
          When a new city is typed in
          ...
          {iso && <NewsUpdate city={city} iso={iso}/>}
          {isLoaded && results &&
            <Suggestions
